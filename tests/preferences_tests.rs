...
fn upgrade_to_https_policy_maps_raw_values() {
    assert_eq!(UpgradeToHTTPSPolicy::from_raw(0), UpgradeToHTTPSPolicy::KeepAsRequested);
    assert_eq!(
    ...
    assert_eq!(UpgradeToHTTPSPolicy::from_raw(3), UpgradeToHTTPSPolicy::ErrorOnFailure);
